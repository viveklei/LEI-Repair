...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const customerPortalLogin = async (trackId?: string, mobileNumber?: string, otp?: string): Promise<string | null> => {
    const res = await api.post('/portal/login', { trackId, mobileNumber, otp });
